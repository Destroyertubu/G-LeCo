...
__device__ uint8_t *write_delta_s(int *in, uint8_t *out, uint8_t l, int numbers, int size)
{
    uint64_t code = 0;
    int occupy = 0;
...
__device__ uint8_t* write_delta(int *in,uint8_t* out, uint8_t l, int numbers){
    uint64_t code =0;
    int occupy = 0;
    int endbit = (l*numbers);
    int end=0;
...
__device__ uint32_t* write_delta32(int *in,uint32_t* out, uint8_t l, int numbers){
    uint64_t code =0;
    int occupy = 0;
    int endbit = (l*numbers);
    int end=0;
...
__device__ uint8_t * write_delta_T(int *in, uint8_t *out, uint8_t l, int numbers)
{
    uint64_t code = 0;
    int occupy = 0;
...
template <typename T>
__device__ uint8_t * write_delta_int_T(T *in, bool* signvec, uint8_t *out, uint32_t l, int numbers)
{
    uint128_t code = 0;
    int occupy = 0;
    uint64_t endbit = (l * (uint64_t)numbers);
...
template <typename T>
__device__ uint8_t * write_FOR_int_T(T *in, uint8_t *out, uint8_t l, int numbers)
{
    uint128_t code = 0;
    int occupy = 0;
    uint64_t endbit = (l * (uint64_t)numbers);
...
__device__ uint8_t* write_delta_default(uint32_t *in,uint8_t* out, uint8_t l, int numbers){
...
__device__ uint8_t *write_string_delta_string(long_int *in, uint8_t *out, uint32_t l, int numbers)
{
    long_int code = 0;
    int occupy = 0;
...
__device__ uint8_t *write_string_delta_string_mpz(std::vector<mpz_t *> in, uint8_t *out, uint32_t l, int numbers)
{
    mpz_t code;
    mpz_init(code);
...
__device__ uint8_t *write_string_delta_string_128(int128_t *in, uint8_t *out, uint32_t l, int numbers)
{
    uint128_t code = 0;
    int occupy = 0;
    uint64_t endbit = (l * numbers);
...
template <typename T>
__global__ uint8_t * write_delta_string(T *in, bool* signvec, uint8_t * string_len, uint8_t *out, uint32_t l, size_t numbers)
{
    T code = 0;
    int occupy = 0;
